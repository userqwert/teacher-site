...
class MusicClass(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("music:lessons_list", args=[str(self.id)])
...
class Lesson(models.Model):
    ...
    subject = models.ForeignKey(
        "MusicClass", on_delete=models.CASCADE, related_name="lessons"
    )
    ...
    def get_absolute_url(self):
        return reverse("music:lesson_detail", args=[str(self.id)])
